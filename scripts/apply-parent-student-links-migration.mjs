...
const migrationPath = resolve(
  __dirname,
  "../supabase/migrations/20260615130000_parent_student_links.sql",
);
...
const verify = await fetch(
  `https://${projectRef}.supabase.co/rest/v1/parent_student_links?select=id&limit=1`,
  {
    headers: {
...
console.log("SUCCESS: parent_student_links table is available.");
