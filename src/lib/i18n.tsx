...
export const t = {
  ...
  khda_command_center_title: {
    en: "KHDA Analytics Command Center",
    ar: "مركز قيادة تحليلات KHDA",
  },
  khda_command_center_subtitle: {
    en: "Executive performance dashboard across grades, sections, and Islamic groups.",
    ar: "لوحة أداء تنفيذية عبر الصفوف والشعب والمجموعات الإسلامية.",
  },
  khda_analytics_loading: { en: "Loading analytics…", ar: "جارٍ تحميل التحليلات…" },
  khda_rating_label: { en: "Rating", ar: "التقييم" },
  khda_no_data: { en: "No data", ar: "لا توجد بيانات" },
  khda_insights_title: { en: "Insights", ar: "رؤى" },
  khda_distribution_title: {
    en: "Student Performance Distribution",
    ar: "توزيع أداء الطلاب",
  },
  khda_distribution_subtitle: {
    en: "Students grouped by KHDA performance bands",
    ar: "الطلاب مصنّفون حسب نطاقات أداء KHDA",
  },
  khda_students: { en: "Students", ar: "الطلاب" },
  khda_submissions: { en: "Submissions", ar: "الإرسالات" },
  khda_trend_title: { en: "Performance Trend", ar: "اتجاه الأداء" },
  khda_trend_empty: {
    en: "Trend will appear when sufficient assessment history is available.",
    ar: "سيظهر الاتجاه عند توفر سجل تقييم كافٍ.",
  },
  khda_islamic_group_title: { en: "Islamic Group Comparison", ar: "مقارنة المجموعات الإسلامية" },
  khda_single_group_only: {
    en: "Comparison requires both Islamic A and Islamic B in the selected scope.",
    ar: "تتطلب المقارنة وجود المجموعة الإسلامية أ و ب في النطاق المحدد.",
  },
  khda_subject_title: {
    en: "Islamic Education vs Qur'an",
    ar: "التربية الإسلامية مقابل القرآن",
  },
  khda_subject_na: {
    en: "Subject comparison is not available for the current scope.",
    ar: "مقارنة المواد غير متاحة للنطاق الحالي.",
  },
  khda_top_students_title: { en: "Top Students", ar: "أفضل الطلاب" },
  khda_rank: { en: "Rank", ar: "الترتيب" },
  khda_student: { en: "Student", ar: "الطالب" },
  khda_grade: { en: "Grade", ar: "الصف" },
  khda_section: { en: "Section", ar: "الشعبة" },
  khda_score: { en: "Score", ar: "الدرجة" },
  khda_top_sections_title: { en: "Top Performing Sections", ar: "أفضل الشعب أداءً" },
  khda_needs_attention_title: { en: "Students Needing Attention", ar: "طلاب يحتاجون متابعة" },
  khda_needs_attention_subtitle: {
    en: "Students with quiz evidence averaging below 60% (KHDA Ratings 1–3).",
    ar: "طلاب لديهم أدلة اختبار بمتوسط أقل من 60٪ (تقييمات KHDA 1–3).",
  },
  khda_needs_attention_empty: {
    en: "No students need attention for current filters.",
    ar: "لا يوجد طلاب يحتاجون متابعة للفلاتر الحالية.",
  },
  khda_filters_title: { en: "Filters", ar: "الفلاتر" },
  khda_filter_grade: { en: "Grade", ar: "الصف" },
  khda_filter_section: { en: "Section", ar: "الشعبة" },
  khda_filter_islamic_group: { en: "Islamic Group", ar: "المجموعة الإسلامية" },
  khda_filter_teaching_subject: { en: "Teaching Subject", ar: "مادة التدريس" },
  khda_filter_all: { en: "All", ar: "الكل" },
  khda_filter_not_set: { en: "Not set", ar: "غير محدد" },
  khda_kpi_students: { en: "Students", ar: "الطلاب" },
  khda_kpi_avg_performance: { en: "Average Performance", ar: "متوسط الأداء" },
  khda_kpi_submissions: { en: "Quiz Submissions", ar: "إرسالات الاختبارات" },
  khda_kpi_certificates: { en: "Certificates", ar: "الشهادات" },
  khda_kpi_meeting_target: { en: "Meeting Target (Good+)", ar: "تحقيق الهدف (جيد+)" },
  khda_performance_by_grade: { en: "Performance by Grade", ar: "الأداء حسب الصف" },
  khda_performance_by_section: { en: "Performance by Section", ar: "الأداء حسب الشعبة" },
  khda_legend_title: { en: "KHDA Performance Scale", ar: "مقياس أداء KHDA" },
  khda_band_1_label: { en: "Very Weak", ar: "ضعيف جدًا" },
  khda_band_2_label: { en: "Weak", ar: "ضعيف" },
  khda_band_3_label: { en: "Acceptable", ar: "مقبول" },
  khda_band_4_label: { en: "Close to Good", ar: "قريب من جيد" },
  khda_band_5_label: { en: "Good", ar: "جيد" },
  khda_band_6_label: { en: "Close to Very Good", ar: "قريب من جيد جدًا" },
  khda_band_7_label: { en: "Very Good", ar: "جيد جدًا" },
  khda_band_8_label: { en: "Outstanding", ar: "ممتاز" },
  khda_qdesc_few: { en: "Few", ar: "عدد قليل" },
  khda_qdesc_minority: { en: "Minority", ar: "أقلية" },
  khda_qdesc_sig_minority: { en: "Significant Minority", ar: "أقلية ملحوظة" },
  khda_qdesc_majority: { en: "Majority", ar: "غالبية" },
  khda_qdesc_large_majority: { en: "Large Majority", ar: "غالبية كبيرة" },
  khda_qdesc_most: { en: "Most", ar: "معظم" },
  khda_qdesc_almost_all: { en: "Almost All", ar: "الجميع تقريبًا" },
  khda_insight_best_grade: {
    en: "{grade} currently has the highest average at {pct} — {ratingLabel}.",
    ar: "{grade} لديه أعلى متوسط حاليًا عند {pct} — {ratingLabel}.",
  },
  khda_insight_section_gap: {
    en: "{section} is {gap} percentage points below the selected-grade average.",
    ar: "{section} أقل بـ {gap} نقطة مئوية عن متوسط الصف المحدد.",
  },
  khda_insight_meeting_target: {
    en: "{pct}% of students with assessment data are at Good (Rating 5) or above{qdescSuffix}.",
    ar: "{pct}% من الطلاب الذين لديهم بيانات تقييم عند جيد (التقييم 5) أو أعلى{qdescSuffix}.",
  },
  khda_insight_best_section: {
    en: "Section {section} leads with {pct} — {ratingLabel}.",
    ar: "الشعبة {section} في المقدمة بـ {pct} — {ratingLabel}.",
  },
